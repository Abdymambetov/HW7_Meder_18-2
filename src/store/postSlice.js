...
const postsSlice = createSlice({
    ...
    reducers: {
        ...
        onePostAction: (state, action) => {
            state.onePost = action.payload
        }
    }
})

export const {postsInfo, deletePost, preloaderOn, preloaderOff, setError, onePostAction} = postsSlice.actions;
